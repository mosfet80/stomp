...
public:
  ...
  /**
   * @brief Find the optimal solution provided an initial guess.
...
protected:
  ...
  /**
   * @brief Computes an initial guess at a solution given a start and end state
   * @param first Start state for the task
   * @param last Final state for the task
   * @return True if successful, otherwise false.
   */
   ...
   * @return True if it was able to successfully perform a single iteration. False
   ...
   * control cost found among the noisy rollouts.
   * @return True if successful, otherwise false.
   */
